...
const THEMES = {
  ...
  light: {
    ...
    borderHover: "#c0c6d0", text: "#0a0b0d", textDim: "#5b616e", textFaint: "#8a909a",
    accent: "#0052ff", accentActive: "#003ecc", onAccent: "#ffffff", accentGlow: "rgba(0,82,255,.22)",
    accentText: "#0052ff",
    inputBg: "#ffffff", heatPos: "#05b169", heatNeg: "#cf202f", heatNeu: "#e4e8ee",
    rowHover: "#eef1f5", band: "#e9edf2",
    posBg: "rgba(5,177,105,.12)", negBg: "rgba(207,32,47,.10)",
    cardShadow: "0 1px 2px rgba(10,11,13,.05), 0 10px 26px rgba(10,11,13,.08)",
